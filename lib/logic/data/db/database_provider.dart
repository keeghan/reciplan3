...
class DatabaseProvider {
  ...
  static List<Recipe> recipes = [
    Recipe(
        ...
        collection: false,
        favorite: false,
        mealType: MealType.missing.dbValue,
    ...
    Recipe(
        ...
        collection: true,
        favorite: true,
        mealType: MealType.breakfast.dbValue,
    ...
    Recipe(
        ...
        collection: true,
        favorite: true,
        mealType: MealType.snack.dbValue,
    ...
    Recipe(
        ...
        collection: false,
        favorite: false,
        mealType: MealType.dinner.dbValue,
    ...
    Recipe(
        ...
        collection: true,
        favorite: false,
        mealType: MealType.lunch.dbValue,
