...
// ignore_for_file: no_leading_underscores_for_local_identifiers, prefer_interpolation_to_compose_strings, override_on_non_overriding_member
...
class _$DayDao extends DayDao {
  ...
  @override
  Stream<Day?> watchDay(int dayId) {
    return _queryAdapter.queryStream('SELECT * FROM day_table WHERE id = ?1',
        mapper: (Map<String, Object?> row) => Day(
            id: row['id'] as int,
            name: row['name'] as String,
            breakfast: row['breakfast'] as int,
